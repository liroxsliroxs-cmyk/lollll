	...
	var Ce = function() {
		...
		return n = e, o = [{
			...
			value: function() {
				...
				return ce("dialog#cconsent-modal", ce("div.ccm__content", ce("div.ccm__content__heading", ce("h2#ccm__content__title", we.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, "modalMainTitle")), ce("span", we.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, "modalMainText"), window.CookieConsent.config.modalMainTextMoreLink ? ce("a", {
